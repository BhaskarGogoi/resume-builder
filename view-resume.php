...
<body style="font-family: 'Roboto', sans-serif; color: #444;">
    ...
    <div style="display: flex; justify-content: space-between;">
        ...
        <?php
        $sql_image = "SELECT * from images where resume_id = '$resume_id';";
        $result_image = $conn->query($sql_image);
        $row_image = mysqli_fetch_assoc($result_image);
        ?>
        <div class="photo"><img src="images/photos/<?php echo $row_image['photo']; ?>" alt=""></div>
    </div>
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 20px;">
        ...
        <div style='text-align: left; width: 200px;'>
            <div class="signature"><img src="images/signature/<?php echo $row_image['signature']; ?>" alt=""></div>
        </div>
    </div>
</body>
