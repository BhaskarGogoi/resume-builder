...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="includes/create-resume.inc.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm mt-5 mb-4">
                <div class="card-body">
                    <h6>Image & Signature</h6>
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                <label class="form-label">Passport Size Photo <span class="required">*</span></label> <br>
                                <input type="file" class="form-control" name="photo" required>
                            </div>
                            <div class="col">
                                <label class="form-label">Signature<span class="required">*</span></label> <br>
